#!/usr/bin/env python3
"""Strict Row-Independence Audit & Sandbox Verification for submit_ref4_shrunk_adaptive_073."""
...
AUDIT_DIR = ROOT / 'model/REF4-SHRUNK-ADAPTIVE-CHAMPION-073A/audit_sandbox'
