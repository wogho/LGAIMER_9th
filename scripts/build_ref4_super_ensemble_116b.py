#!/usr/bin/env python3
"""
REF4-V66-EXPOSURE-SIGMOID-116B Builder.
Candidate 116B: 116A + 10th Repo Direct Additive Batter Exposure (v59) & Residual (v61) + Continuous Sigmoidal Gating.
"""
import json
import os
import shutil
...
OUT_DIR = ROOT / "model/REF4-V66-EXPOSURE-SIGMOID-116B/production_package"
ZIP_OUT = ROOT / "output/submit_ref4_super_ensemble_116B.zip"

def main():
    print("=" * 80)
    print("  PACKAGING CANDIDATE 116B: REF4-V66-EXPOSURE-SIGMOID-116B  ")
    print("=" * 80)
    ...
    manifest["pipeline"] = "REF4-V66-EXPOSURE-SIGMOID-116B"
    manifest["description"] = "116A + 10th Repo Direct Additive Batter Exposure & Continuous Sigmoidal Gating"
    ...
    script_code = '''# Production inference entry point for REF4-V66-EXPOSURE-SIGMOID-116B
import json
import os
import sys
import time
...
def main():
    ...
    # =========================================================================
    # 116B: 10th Repo DIRECT ADDITIVE v66 Nested EB + v59 Batter Exposure
    # =========================================================================
