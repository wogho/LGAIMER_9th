#!/usr/bin/env python3
"""Independent verification for REF4-TRAINONLY-R-LGBM-CONSERVATIVE-063A."""
...
def main():
    ...
    # 3. Model files
    all_models_exist = (OUT / 'r_expert_lgbm_2023.txt').exists() and (OUT / 'r_expert_lgbm_2024.txt').exists()
    checks.append({'name': 'model_files', 'pass': all_models_exist})
    ...
    print(f"063A Verification completed: status={status}, promotion_pass={promotion}")
