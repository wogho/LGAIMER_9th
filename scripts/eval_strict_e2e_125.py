...
Evaluates 113A Champion Base (1121.90 LB) vs 125 Team-13 Hub Regime & Boundary Inversion (Convex Blend).
"""
import json
import os
import shutil
...
def evaluate_production_package(pkg_path: Path, val_df: pd.DataFrame, n_rows: int = 15000):
    ...
    sandbox = Path(tempfile.mkdtemp(prefix="strict_125_"))
    try:
        pkg_dir = sandbox / "pkg"
...
def main():
    print("=" * 80)
    print("  STRICT REAL END-TO-END EVALUATION: 113A (1121.90 LB) vs 125 REGIME-13-HUB  ")
    print("=" * 80)
    ...
    candidates = [
        ...
        ("125 Team-13 Hub Regime Model", ROOT / "model/REF4-REGIME-13-HUB-125/production_package"),
    ]
    ...
    print("\n" + "=" * 80)
    print("  FINAL 125 SCOREBOARD (TRUE END-TO-END HOLD-OUT EVALUATION)  ")
    print("=" * 80)
