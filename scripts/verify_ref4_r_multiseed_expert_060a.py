#!/usr/bin/env python3
"""Independent verification for REF4-TRAINONLY-R-MULTISEED-EXPERT-060A."""
...
def main():
    ...
    for yr in (2023, 2024):
        for s_val in seeds:
            m_path = OUT / f"r_expert_{yr}_seed_{s_val}.cbm"
    ...
    print(f"060A Verification completed: status={status}, promotion_pass={promotion}")
