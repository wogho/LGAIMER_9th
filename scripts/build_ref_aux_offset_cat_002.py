#!/usr/bin/env python3
"""Build a deterministic, isolated research ZIP for REF-AUX-OFFSET-CAT-002."""
...
CANDIDATE = ROOT / "candidate" / "REF-AUX-OFFSET-CAT-002"
OUT = ROOT / "output" / "candidates" / "submit_ref_aux_offset_cat_002.zip"
FILES = [
...
def main() -> None:
    ...
    manifest = {
        "experiment_id": "REF-AUX-OFFSET-CAT-002",
        "zip_path": str(OUT),
