#!/usr/bin/env python3
"""
REF4-EB-V66-NESTED-114A Builder.
Candidate 114A: 113A Champion (1121.90) + 10th Repo Full Core (v66 3-Axis Nested EB + v59/v61 Batter Exposure).
"""
import json
import os
import shutil
...
OUT_DIR = ROOT / "model/REF4-EB-V66-NESTED-114A/production_package"
ZIP_OUT = ROOT / "output/submit_ref4_super_ensemble_114A.zip"

def main():
    print("=" * 80)
    print("  PACKAGING CANDIDATE 114A: REF4-EB-V66-NESTED-114A  ")
    print("=" * 80)
    ...
    manifest["pipeline"] = "REF4-EB-V66-NESTED-114A"
    manifest["description"] = "113A Champion + 10th Repo v66 Nested Deviations + v59/v61 Batter Exposure"
    ...
    script_code = '''# Production inference entry point for REF4-EB-V66-NESTED-114A
import json
import os
import sys
import time
...
def main():
    ...
    # =========================================================================
    # 114A: 10th Repo Full Core Integration (v66 Nested EB + v59/v61 Exposure)
    # =========================================================================
    # 1. v66 3-Axis Nested Deviations (Platoon, Advantage, Runner)
    v66_delta = apply_10th_repo_v66_deviations(test, MODEL / "v66_nested_deviations.json")
    
    # 2. v59 Batter Exposure Centered Delta
    ...
    # 3. v61 Batter k=2000 Shrunk Residual
    ...
    logit_p_new = logit_p + w_v66 * v66_delta + w_v59 * v59_delta - w_v61 * v61_delta
