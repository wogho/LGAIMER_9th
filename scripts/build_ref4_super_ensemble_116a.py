#!/usr/bin/env python3
"""
REF4-DIRECT-V66-116A Builder.
Candidate 116A: 113A Champion (1121.9040) + 10th Repo Direct Additive v66 Nested Deviations.
"""
import json
import os
import shutil
...
OUT_DIR = ROOT / "model/REF4-DIRECT-V66-116A/production_package"
ZIP_OUT = ROOT / "output/submit_ref4_super_ensemble_116A.zip"

def main():
    print("=" * 80)
    print("  PACKAGING CANDIDATE 116A: REF4-DIRECT-V66-116A  ")
    print("=" * 80)
    ...
    manifest["pipeline"] = "REF4-DIRECT-V66-116A"
    manifest["description"] = "113A Champion (1121.9040) + 10th Repo Original Direct Additive v66 Nested Deviations"
    ...
    script_code = '''# Production inference entry point for REF4-DIRECT-V66-116A
import json
import os
import sys
import time
...
def main():
    ...
    # =========================================================================
    # 116A: 10th Repo Original DIRECT ADDITIVE Nested Deviations on p
    # =========================================================================
