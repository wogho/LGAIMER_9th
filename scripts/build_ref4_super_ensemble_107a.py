#!/usr/bin/env python3
"""Build Production Package 107A: 103A Champion Backbone (1107.1970 LB) + 6번 레포 (1146.3952 LB) Dedicated 61-Feature Orthogonal Residual Booster (w=0.05)."""
...
def main():
    ...
    # 107A NEW: 6번 레포 (1146.3952 LB) Dedicated 61-Feature Orthogonal Residual Booster (w=0.05)
...
def build_package():
    ...
    print("\n=== Step 2: Training 6번 레포 Dedicated 61-Feature Residual Booster on Full Train (1,475,092 rows) ===")
    ...
    manifest['notes'] = "107A Champion 103A Backbone (1107.1970 LB) + 6번 레포 (1146.3952 LB) Dedicated 61-Feature Orthogonal Residual Booster (w=0.05)"
