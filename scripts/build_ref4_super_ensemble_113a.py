#!/usr/bin/env python3
"""
REF4-DISJOINT-EB-113A Builder.
Candidate 113A: 112C Base + Real Disjoint Matchup Empirical Bayes Expert Model.
"""
import json
import os
import shutil
...
OUT_DIR = ROOT / "model/REF4-DISJOINT-EB-113A/production_package"
ZIP_OUT = ROOT / "output/submit_ref4_super_ensemble_113A.zip"

def main():
    print("=" * 80)
    print("  PACKAGING CANDIDATE 113A: REF4-DISJOINT-EB-113A  ")
    print("=" * 80)
    ...
    manifest["pipeline"] = "REF4-DISJOINT-EB-113A"
    manifest["description"] = "112C Base + Real Disjoint Matchup Empirical Bayes Expert"
    manifest["created_at"] = time.strftime("%Y-%m-%d %H:%M:%S")
    manifest["w_disjoint_eb"] = 0.035
    ...
    script_code = '''# Production inference entry point for REF4-DISJOINT-EB-113A
import json
import os
import sys
import time
...
def main():
    ...
    # 113A: Real Disjoint Matchup Empirical Bayes Expert
