#!/usr/bin/env python3
"""Build Production Package 071A with explicit requirements.txt."""
import gc, hashlib, json, os, shutil, sys, time, zipfile
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
EXP_DIR = ROOT / 'model/REF4-ADAPTIVE-CHANNEL-OPT-071A'
...
def main():
    ...
    print("=== Step 2: Packaging submit_ref4_adaptive_channel_opt_071.zip ===")
    zip_path = ROOT / 'output/submit_ref4_adaptive_channel_opt_071.zip'
    ...
    report = {
        'experiment_id': 'REF4-ADAPTIVE-CHANNEL-OPT-071A',
