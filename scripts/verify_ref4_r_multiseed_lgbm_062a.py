#!/usr/bin/env python3
"""Independent verification for REF4-TRAINONLY-R-MULTISEED-LGBM-062A."""
...
def main():
    ...
    for yr in (2023, 2024):
        for s_val in seeds:
            m_path = OUT / f"r_expert_lgbm_{yr}_seed_{s_val}.txt"
    ...
    print(f"062A Verification completed: status={status}, promotion_pass={promotion}")
