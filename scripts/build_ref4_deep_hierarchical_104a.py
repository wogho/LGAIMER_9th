#!/usr/bin/env python3
"""Build Production Package 104A: New Champion 103A Backbone (1107.1970 LB) + 8번 레포 Refined Location 5-Class Multi-Class Target Sub-Expert Integration."""
...
def main():
    ...
    # 104A NEW: 8번 레포 Refined Location 5-Class Multi-Class Sub-Expert (w=0.03)
...
def build_package():
    t0 = time.time()
    print("=== Step 1: Training 8번 레포 Refined Location 5-Class Multi-Class CatBoost Sub-Expert ===")
    ...
    # 8번 레포 Refined Location 5-Class Target 분해:
    ...
    manifest['notes'] = "104A Champion 103A Backbone (1107.1970 LB) + 8번 레포 Refined Location 5-Class Multi-Class Sub-Expert (w=0.03)"
