...
EXP_DIR = ROOT / 'model/REF4-DEEP-HIERARCHICAL-097A'
...
SCRIPT_CONTENT_097 = '''"""Offline inference entry point for REF4-DEEP-HIERARCHICAL-097A."""
...
def main():
    ...
    # Pre-build v54 features for 097A Hierarchical Baseline L2 residual engine
    v54_feat = None
    p_hb_hier = None
    if regular.any():
    ...
    # 097A FULL ADOPTION: 20 Pure L2 Models Retrained on Hierarchical Reliability Residuals
...
def build_package():
    ...
    manifest['version'] = 'REF4-DEEP-HIERARCHICAL-097A'
    ...
    print("\n=== Step 3: Writing script.py and Packaging submit_ref4_deep_hierarchical_097.zip ===")
    (PROD_DIR / 'script.py').write_text(SCRIPT_CONTENT_097, encoding='utf-8')
    
    zip_path = ROOT / 'output/submit_ref4_deep_hierarchical_097.zip'
    if zip_path.exists():
        zip_path.unlink()
