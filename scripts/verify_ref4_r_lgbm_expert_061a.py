#!/usr/bin/env python3
"""Independent verification for REF4-TRAINONLY-R-LGBM-EXPERT-061A."""
...
def main():
    ...
    # 3. Model files
    m2023 = OUT / 'r_expert_lgbm_2023.txt'
    m2024 = OUT / 'r_expert_lgbm_2024.txt'
    ...
    print(f"061A Verification completed: status={status}, promotion_pass={promotion}")
