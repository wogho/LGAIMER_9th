#!/usr/bin/env python3
"""
REF4-EXPERT-CONVEX-114C Builder.
Candidate 114C: 113A Champion + 10th Repo Full Core + Pitch Tunneling Specialist + SLSQP Logit-Simplex Blending.
"""
import json
import os
import shutil
...
OUT_DIR = ROOT / "model/REF4-EXPERT-CONVEX-114C/production_package"
ZIP_OUT = ROOT / "output/submit_ref4_super_ensemble_114C.zip"

def main():
    print("=" * 80)
    print("  PACKAGING CANDIDATE 114C: REF4-EXPERT-CONVEX-114C  ")
    print("=" * 80)
    ...
    # 4. Copy 10th repo frozen tables
    ...
    manifest["pipeline"] = "REF4-EXPERT-CONVEX-114C"
    manifest["description"] = "113A + 10th Repo + Pitch Tunneling + SLSQP Logit-Simplex Optimization"
    ...
    manifest["w_super_resid_base"] = 0.088
    manifest["w_refined_call_base"] = 0.042
    ...
    script_code = '''# Production inference entry point for REF4-EXPERT-CONVEX-114C
import json
import os
import sys
import time
...
def main():
    ...
    # 114C: Pitch Tunneling & Count-Tension Specialist
    ...
    # =========================================================================
    # 114C: 10th Repo Full Core Integration + Logit-Simplex Optimization
    # =========================================================================
