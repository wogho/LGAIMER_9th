"""v5.1 Deep 65 Feature and Hierarchical Base Extractor."""
from pathlib import Path
import json
import numpy as np
import pandas as pd

def build_v51_deep_65_features(df: pd.DataFrame, profile_path: Path | str | None = None, prior: float = 0.523766) -> tuple[pd.DataFrame, np.ndarray]:
    """Build 65 full features and compute hierarchical_base cleanly and row-independently."""
    ...
    # 5. NEW v5.1 Refined Bayesian & Matchup Advantage Features (4 features -> Total 65)
